...
will be used to impute categorical features. # You can add your own preprocessing steps such as: Normalization 
Outlier removal Handling imbalanced classes Dropping or adding features 
